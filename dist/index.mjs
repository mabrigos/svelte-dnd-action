...
var _excluded = ["items", "flipDurationMs", "type", "dragDisabled", "morphDisabled", "dropFromOthersDisabled", "zoneTabIndex", "zoneItemTabIndex", "dropTargetStyle", "dropTargetClasses", "transformDraggedElement", "autoAriaDisabled", "centreDraggedOnCursor", "delayTouchStart", "dropAnimationDisabled", "keyboardDisabled"];
...
function dndzone(node, options) {
  ...
  var keyboardZone = options.keyboardDisabled ? null : dndzone$1(node, options);
  return {
    update: function update(newOptions) {
